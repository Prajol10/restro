...
const RestaurantPage = () => {
  ...
  return (
    <div style={{ backgroundColor: bgColor, color: bgColor ? ((() => { const hex = bgColor.replace('#',''); const r=parseInt(hex.substr(0,2),16),g=parseInt(hex.substr(2,2),16),b=parseInt(hex.substr(4,2),16); return (r*299+g*587+b*114)/1000>128?'#111111':'#ffffff'; })()) : '#ffffff', minHeight: '100vh' }}>
      <Navbar
