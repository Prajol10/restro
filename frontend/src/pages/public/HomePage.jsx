...
const HomePage = () => {
  ...
  const S = {
    ...
    darkSection: { backgroundColor: '#111111', padding: '100px 0' },
    ...
    card: { backgroundColor: '#111111', border: '1px solid rgba(255,255,255,0.06)', padding: '28px', textAlign: 'center' },
    ...
    reviewCard: { backgroundColor: '#111111', border: '1px solid rgba(255,255,255,0.06)', padding: '28px' },
