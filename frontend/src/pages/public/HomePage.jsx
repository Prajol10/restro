...
const HomePage = () => {
  ...
  const S = {
    ...
    darkSection: { backgroundColor: restaurant.bgColor || '#0d0d0d', padding: isMobile ? '60px 0' : '100px 0', borderTop: '1px solid rgba(255,255,255,0.05)' },
    ...
    card: { backgroundColor: restaurant.primaryColor || '#111', border: '1px solid rgba(255,255,255,0.06)', padding: '28px', textAlign: 'center' },
    ...
    reviewCard: { backgroundColor: restaurant.primaryColor || '#111', border: '1px solid rgba(255,255,255,0.06)', padding: '28px' },
