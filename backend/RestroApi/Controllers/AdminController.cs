...
namespace RestroApi.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateRestaurant([FromBody] UpdateRestaurantDto dto)
        {
            ...
            r.LogoUrl = !string.IsNullOrEmpty(dto.LogoUrl) ? dto.LogoUrl : r.LogoUrl;
            r.BannerUrl = dto.BannerUrl != null ? dto.BannerUrl : r.BannerUrl;
            r.VideoUrl = !string.IsNullOrEmpty(dto.VideoUrl) ? dto.VideoUrl : r.VideoUrl;
            ...
            r.Tagline = !string.IsNullOrEmpty(dto.Tagline) ? dto.Tagline : r.Tagline;
            r.HeroTitle = !string.IsNullOrEmpty(dto.HeroTitle) ? dto.HeroTitle : r.HeroTitle;
            r.HeroSubtitle = !string.IsNullOrEmpty(dto.HeroSubtitle) ? dto.HeroSubtitle : r.HeroSubtitle;
